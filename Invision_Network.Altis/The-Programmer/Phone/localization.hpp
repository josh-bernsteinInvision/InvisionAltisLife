class Phone_Localization {
    ...
    class STR_END_CALL {
        en = "<t color='#00981E'>Call with %1 ended, duration : %2</t>";
        fr = "<t color='#00981E'>Conversation avec %1 finie, temps : %2</t>";
        de = "<t color='#00981E'>Anruf mit %1 beendet, Länge : %2</t>";
        es = "<t color='#00981E'>Llamada con %1 terminada, duracion : %2</t>";
    };
    class STR_IN_CALL {
        en = "Conversation with %1, duration : %2 (Alt + R to hang up)";
        fr = "Conversation en cours avec %1, temps : %2 (Alt + R pour raccrocher)";
        de = "Anruf mit %1, Länge : %2 (Alt + R um aufzulegen)";
        es = "Conversacion con %1, duracion : %2 (ALT + R para colgar)";
    };
    ...
    class STR_SEND_X_ANO {
        en = "You have sent %2 to %1 (in anonym)";
        fr = "Vous avez envoyé a %1 : %2 (en anonyme)";
        de = "Du hast %1 Anonym eine Nachricht geschickt: %2";
        es = "Has enviado %2 a %1 (en anonimo)";
    };
