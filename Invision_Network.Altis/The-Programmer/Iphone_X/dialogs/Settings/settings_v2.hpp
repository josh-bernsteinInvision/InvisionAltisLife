...
class The_Programmer_Iphone_Settings_Menu_2 {
   ...
   class controls
   {
       class VD_onfoot_value : Life_RscEditWithNoBorder
       {
           idc = 2902;
           text = "";
           onchar = "[_this select 0, _this select 1,'ground',false] call The_programmer_iphone_fnc_s_onCharSetting;";
           onkeyup = "[_this select 0, _this select 1,'ground',true] call The_programmer_iphone_fnc_s_onCharSetting;";
       ...
       class VD_car_value : Life_RscEditWithNoBorder
       {
           idc = 2912;
           text = "";
           onchar = "[_this select 0, _this select 1,'vehicle',false] call The_programmer_iphone_fnc_s_onCharSetting;";
           onkeyup = "[_this select 0, _this select 1,'vehicle',true] call The_programmer_iphone_fnc_s_onCharSetting;";
           x = 0.747083333333333 * safezoneW + safezoneX;
       ...
       class VD_air_value : Life_RscEditWithNoBorder
       {
           idc = 2922;
           text = "";
           onchar = "[_this select 0, _this select 1,'air',false] call The_programmer_iphone_fnc_s_onCharSetting;";
           onkeyup = "[_this select 0, _this select 1,'air',true] call The_programmer_iphone_fnc_s_onCharSetting;";
           x = 0.747083333333333 * safezoneW + safezoneX;
       ...
       class Son_Sms : Life_RscButtonInvisible
       {
       ...
       class Desactivee : Life_RscButtonInvisible
       {
           x = 0.654288833333333 * safezoneW + safezoneX;
       ...
       class Faible : Life_RscButtonInvisible
       {
           x = 0.654288833333333 * safezoneW + safezoneX;
       ...
       class Normal : Life_RscButtonInvisible
       {
           x = 0.654288833333333 * safezoneW + safezoneX;
       ...
       class Eleve : Life_RscButtonInvisible
       {
           x = 0.654288833333333 * safezoneW + safezoneX;
       ...
       class Fond_Ecran : Life_RscButtonInvisible
       {
           x = 0.654288833333333 * safezoneW + safezoneX;
       ...
       class MORE : Life_RscButtonInvisible
       {
           x = 0.807894833333333 * safezoneW + safezoneX;
